...
3. Подтяните скачанный архив в рабочую среду и обновите данные функцией `import_from_cvat`. Таким образом можно, в том числе, преобразовать разметку из формата YOLO в формат для других архитектур (например, Faster R-CNN).
